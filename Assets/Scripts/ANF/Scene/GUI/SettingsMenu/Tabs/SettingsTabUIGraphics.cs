    ...
    public class SettingsTabUIGraphics : SettingsTabUI
    {
        ...
        public override void PopulateTab()
        {
            if (PersistentDataManager.instance.GetGlobalData().GetComponent(out ScreenSettingsContainer screenSettings))
            {
                ...
                {
                    vSyncToggle = menu.CreateToggle("SettingsMenu_Graphics_VSync", root);
...

                {
                    ...
                    antiAliasingDropdown = menu.CreateDropdown("SettingsMenu_Graphics_AntiAliasing", root);
...

                {
                    ...
                    shadowsDropdown = menu.CreateDropdown("SettingsMenu_Graphics_Shadows", root);
