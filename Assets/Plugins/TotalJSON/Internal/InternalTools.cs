...
namespace Leguar.TotalJSON.Internal
{
	...
	internal static class InternalTools
	{
		...
		private static JValue objectAsJValue(object value, List<object> stack)
		{
			...
			if (value is Color)
			{
				return colorToJArray((Color)(value), new JArray(), stack);
			}

			// List/array
			if (value is Vector2)
			{
				return vector2ToJArray((Vector2)(value), new JArray(), stack);
			}

			// List/array
			if (value is Vector3)
			{
				return vector3ToJArray((Vector3)(value), new JArray(), stack);
			}
		...
		internal static JArray colorToJArray(Color sourceColor, JArray targetJArray, List<object> stack)
		{
			targetJArray.Add(sourceColor.r);
			targetJArray.Add(sourceColor.g);
			targetJArray.Add(sourceColor.b);
			targetJArray.Add(sourceColor.a);
			return targetJArray;
		}

		internal static JArray vector2ToJArray(Vector2 sourceVector, JArray targetJArray, List<object> stack)
		{
			targetJArray.Add(sourceVector.x);
			targetJArray.Add(sourceVector.y);
			return targetJArray;
		}

		internal static JArray vector3ToJArray(Vector3 sourceVector, JArray targetJArray, List<object> stack)
		{
			targetJArray.Add(sourceVector.x);
			targetJArray.Add(sourceVector.y);
		...
		internal static JArray vector4ToJArray(Vector4 sourceVector, JArray targetJArray, List<object> stack)
		{
			targetJArray.Add(sourceVector.x);
			targetJArray.Add(sourceVector.y);
			targetJArray.Add(sourceVector.z);
