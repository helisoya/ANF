...
namespace ANF.ANSL
{
    ...
    [ANSLFunctionAttribute(
        ...
        functionAutoComplete: new string[] {
            ...
            "setStaticRotation(Name;X;Y;Z;Duration;WaitForEnd)",
            "setStaticRotation(Name;Marker)",
            "setStaticRotation(Name;Marker;Duration;WaitForEnd)"
        },
        functionDesc: "Rotates a static object")]
    public class SetStaticRotationFunction : ANSLFunction
    {
